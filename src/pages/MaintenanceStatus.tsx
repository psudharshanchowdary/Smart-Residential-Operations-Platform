            ...
            <div key={r.id} className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
              ...
              <div className="p-4">
                <div className="flex items-start justify-between">
                  <div>
                    <p className="text-xs text-muted-foreground">#{r.id.slice(-6).toUpperCase()}</p>
                ...
                {r.admin_note && (
                  <p className="text-xs text-primary mt-1 font-medium">📝 {r.admin_note}</p>
                )}
                {r.image && (
                ...
                {r.technician_name && (
                  <div className="mt-3 p-3 bg-primary/5 border border-primary/20 rounded-xl space-y-1">
                    ...
                    <p className="text-xs font-semibold text-foreground">{r.technician_name}</p>
                    <p className="text-[11px] text-muted-foreground">Employee ID: {r.technician_id}</p>
                    <a
                      href={`tel:${r.technician_phone}`}
